...
Use the provided prompt (`prompt.md` on GitHub) as your initial guide. Here are 8 Python bugs that
you'll attempt to use LLMs to help you debug. The first 7 raise errors; the
last one runs without an error but silently does nothing. Make sure to run
the code in Jupyter first and then try to debug!
